...
public class ClienteService {
    ...
    public ResponseEntity<?> updateCliente(Cliente clienteToUpdate) {
        ...
        try {
            ...
            if (clienteToUpdate.getCnh() != null) cliente.setCnh(clienteToUpdate.getCnh());
            if (clienteToUpdate.getNome() != null) cliente.setNome(clienteToUpdate.getNome());
            if (clienteToUpdate.getEndereco() != null) cliente.setEndereco(clienteToUpdate.getEndereco());
